import 'package:eyesofcosmos/presentation/srceens/onboarding/page_2.dart';
        ...
        children: <Widget>[
          ...
          Column(
            ...
            children: <Widget>[
              ...
              const Text(
                'Embark on a Journey Beyond the Cosmos',
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.white,
                  fontFamily: 'PoetsenOne',
              ...
              duration: const Duration(milliseconds: 500)
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color.fromARGB(255, 134, 228, 176),
                  ...
                  child: Text("Start Exploring".toUpperCase()),
                ),
              ),
              SizedBox(
